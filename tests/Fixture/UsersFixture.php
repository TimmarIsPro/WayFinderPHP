...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role' => ['type' => 'string', 'length' => 11, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role' => 'Lorem ips',
                'created' => '2018-05-22 05:56:00',
                'modified' => '2018-05-22 05:56:00'
            ],
        ];
        parent::init();
    }
